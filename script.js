function loadContent(section) {
    ...
    if (section === 'home') {
      ...
      contentDiv.innerHTML = 
        <div id="Aboutme">
          <h1>About Me</h1>
          <article> Dit is de inhoud van de sectie over het Aboutme. Hallo mijn naam is Pascal en leuk dat je op mijn website kijkt. Momenteel zit ik op school bij het clv. Mijn hobbies zijn gamen en chillen met vrienden.</article>
        </div>
      ;
